    ...
    function showDetail(index) {
      ...
      document.getElementById("id_detailPonuka").style.display = "block";
    ...
    function showList() {
      ...
      document.getElementById("id_detailPonuka").style.display = "none";
    ...
    // Eventy
//    document.getElementById("id_btn-it").addEventListener("click", () => setCategory("it"));
//    document.getElementById("id_btn-eng").addEventListener("click", () => setCategory("eng"));
